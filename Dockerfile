...
## C2ME
RUN wget --progress=bar:force --content-disposition -P mods "https://cdn.modrinth.com/data/VSNURh3q/versions/Bl0VOr1e/c2me-fabric-mc1.21.10-0.3.5%2Bbeta.1.0.jar"
## Fabric API
...
USER 1000
EXPOSE 25565
CMD ["java", "-XX:+UseLargePages", "-XX:+UseTransparentHugePages", "-XX:MaxRAMPercentage=85", "-XX:+UseZGC", "-XX:+ZGenerational", "-XX:ZUncommitDelay=30", "-jar", "fabric-server-launch.jar"]
